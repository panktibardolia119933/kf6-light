...
var plugin = function plugin(editor) {
    ...
    editor.ui.registry.addButton('drawingTool', {
        tooltip: 'drawingTool',
        icon: 'edit-block',
        onAction: function onclick() {
            console.log("Clicked!!!")
            editor.onDrawButton();
            // editor.windowManager.openUrl({

            //     title: 'Drawing Tool',
            //     url: '/drawing-tool/svg/index.html',
            //     width: 710,
            //     height: 600,
        ...
        if (e.target.tagName === ("IMG" || "img")) {
            ...
            editor.windowManager.openUrl({
                ...
                onMouseOver: function onMouseOver() {
                    if (count == 0) {
                        var wnds = document.getElementsByClassName("mce-container-body mce-window-body mce-abs-layout")[0].childNodes;
                        var wnd1 = null;
                        for(var i = 0; i < wnds.length; i++){
                          if(wnds[i].src.endsWith("drawing-tool/svg/index.html")) {
                            //Found the element
                            if(wnd1 !== null) {
                              ...
                              wnd1 = wnds[i].contentWindow.svgCanvas.setSvgString(svg);;
                            }
                          }
                        }
                        count++;
